...
const AddSubApps = (props: Props) => {
  ...
  const onOk = async () => {
    ...
    const params = {
      fdAppName: fdAppName,
      fdAppUrl: fdAppUrl, //关联模块的Id
      fdParent: fdParent,		//关联的模块标识
      fdRemark: fdRemark,
    }
    ...
    // const res = await dispatchRedux(asyncThunk.AddSubApps(params) as any);
