...
const items: MenuItem[] = [
  getItem('应收', 'app', <AppstoreFilled />),
  getItem('实收', 'todo', <CheckCircleOutlined />),
  getItem('欠付', 'integration', <GoldFilled />),
  getItem('付款记录', 'usercenter', <UserOutlined />),
];
